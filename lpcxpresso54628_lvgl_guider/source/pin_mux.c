...
- pin_list:
  ...
  - {pin_num: A3, peripheral: GPIO, signal: 'PIO3, 10', pin_signal: PIO3_10/SCT0_OUT3/CTIMER3_MAT0/EMC_DYCSN(1)/TRACEDATA(0)}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    IOCON->PIO[3][10] = ((IOCON->PIO[3][10] &
                          ...
                          * : PORT310 (pin A3) is configured as PIO3_10. */
    ...
    IOCON->PIO[4][0] = ((IOCON->PIO[4][0] &
                        ...
                        /* Selects pin function.
                         * : PORT40 (pin H13) is configured as PIO4_0. */
                        | IOCON_PIO_FUNC(PIO40_FUNC_ALT0)
