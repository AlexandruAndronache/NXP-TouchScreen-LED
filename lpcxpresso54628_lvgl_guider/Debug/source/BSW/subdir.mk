...
C_SRCS += \
../source/BSW/Bsw_DHT11.c \
../source/BSW/Bsw_Gpio.c \
../source/BSW/Bsw_Pwm.c 

C_DEPS += \
./source/BSW/Bsw_DHT11.d \
./source/BSW/Bsw_Gpio.d \
./source/BSW/Bsw_Pwm.d 

OBJS += \
./source/BSW/Bsw_DHT11.o \
./source/BSW/Bsw_Gpio.o \
./source/BSW/Bsw_Pwm.o 


# Each subdirectory must supply rules for building sources it contributes
source/BSW/%.o: ../source/BSW/%.c source/BSW/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-BSW

clean-source-2f-BSW:
	-$(RM) ./source/BSW/Bsw_DHT11.d ./source/BSW/Bsw_DHT11.o ./source/BSW/Bsw_Gpio.d ./source/BSW/Bsw_Gpio.o ./source/BSW/Bsw_Pwm.d ./source/BSW/Bsw_Pwm.o

.PHONY: clean-source-2f-BSW
